...
public class QuestionController {
     ...
     public List<Question> getQuestionsByCategory(@PathVariable String category){  //I didn't pass the variable to the path like @PathVariable("category") cause the mapping route name is the same thing as the dynamic path name i.e {category}.
